                      ...
                      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          ...
                          <div class="carousel-item active layer">
                            <img src="assets/images/brand/Gucci.jpg " style="height: 90vh;" class="d-block w-100" alt="...">
...
<?php
//   getting brand catogery from privious page
  $b_cat= $_GET['cat'];
 echo('<div class="main-content mt-0">
 <!-- content -->
 <div class="container-fluid content-top-gap">
 <!-- faq block style-->
...
//   getting category data from the server
$sql= "SELECT * FROM `shoes` WHERE b_name= '$b_cat'";
$result= mysqli_query($conn, $sql);
while($row= mysqli_fetch_assoc($result))
{
    $bname= $row['b_name'];
    $bcat= $row['b_cat'];
    $brating= $row['b_rating'];
    $bprice= $row['b_price'];
    $bleft= $row['b_left'];
    $blike= $row['b_like'];
    $bimgname= $row['b_img_name'];
        ...
        <div class="col-lg-4 col-md-6 px-2 mb-4">
                    <div class="card card_border">
                      <div class="content">
                        ...
                        <img src="assets/images/shoes/'.$bimgname.'.jpg" class="img-fluid" style="height: 40vh; width: 100% ;">
                        <div class="content-details fadeIn-top">
                          <a href=""  target="_blank" class="btn-primary btn-style">Know More</a>
                        </div>
                      </div>
                      <div class="card-footer text-muted chart-grid__footer p-4">
                        <a class="card__title" href="#link">'.$bname.' '.$bcat.'</a>
                        <ul class="star">
                         
                          <li>('.$brating.' ratings)</li>
                        </ul>
                        <ul class="cost d-flex">
                          <li><span class="fa fa-inr"></span>'.$bprice.'</li>
                          <li class="ml-3"><span class="fa fa-sign-out"></span> '.$bleft.'</li>
                          <li class="ml-3"><a href="#fav" title="Add this to Favorite"><span class="fa fa-heart-o m-0"></span>'.$blike.'</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
